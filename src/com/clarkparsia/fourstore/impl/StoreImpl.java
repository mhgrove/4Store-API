...
import com.clarkparsia.fourstore.api.ResultFormat;
		...
		try {
			...
			if (aResponse.hasErrorCode()) {
				...
				try {
					...
					SparqlXmlResultSetParser aHandler = new SparqlXmlResultSetParser(new ResultSetBuilder(new FourStoreValueFactory()));
